...
public class MemberController {
	...
	@PostMapping("/login")
	public String login(@RequestParam String empId, @RequestParam String empPw, HttpSession session) {
	    MemberVO userInfo = memberService.getMemberById(empId); // DB에서 회원 정보 조회
	    if (userInfo != null) {
	...
	@GetMapping("/profile") 
	public String profilePage(Model model, MemberVO memberVO) {
	...
	@ResponseBody
	public byte[] getProfileImage(@RequestParam("empId") String empId) {
