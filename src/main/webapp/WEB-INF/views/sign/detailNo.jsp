      ...
      <h6 class="mb-4">기안 자세히 보기</h6>
		<form id="frm" action="/sign/createFormPost" method="post">
			...
			<div class="input-group mb-3">
                 ...
                 <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"  value="${appLineList2.empName}${appLineList2.postName} ">
                 </c:forEach>
             </div>
				<div class="input-group mb-3">
			...
			<select class="form-select form-select-sm mb-3" aria-label=".form-select-sm example" id="appDocName" disabled >
             ...
             <div class="form-floating mb-3">
                <input type="text" class="form-control" id="docTitle" value="${signVO.docTitle}" placeholder="제목" style="color:#ccc" disabled >
                <label for="floatingInput" onclick="event.preventDefault();" ></label>
            </div>
            <div class="form-floating">
                <textarea  class="form-control" placeholder="Leave a comment here" id="docContent" style="height: 500px;"
            ...
            <div>
 			...
 			<button type="button" id="retractButton" class="btn btn-outline-danger m-2 retractButton" style="float: right;" ${disabled}>반려</button>
 	    			 ...
 	    			 $(".approval-cell").html("X");
    	    		   ...
    	    		   if(result.resultCode==200){
    	    			  /*  alert(result.resultMessage); */
    		    		   ...
    		    		   $(".retractButton").css("display","none");  // 버튼을 숨깁니다
    		               $("#approveButton").hide();  // 버튼을 숨깁니다
