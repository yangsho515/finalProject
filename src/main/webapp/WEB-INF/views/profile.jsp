			...
			<div class="col-md-8">
				<div class="card shadow-sm">
					<div class="card-body2">
						...
						<p>
							<strong>직급:</strong> ${userInfo.postName}
						</p>
						<p>
...
<!-- 						<button type="button" id="createDoc" class="btn btn-primary">@@@@@@@@@뭐시기작성</button> -->
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" action="/main/profile/edit" method="post"
	...
	document.getElementById("createDoc").addEventListener("click", function() {
        window.location.href = "/cash/expenseReport";
    });
		// 모달 열기
