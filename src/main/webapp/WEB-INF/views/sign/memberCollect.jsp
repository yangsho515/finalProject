...
margin-top:1%;
	...
	<div class="conte">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <!-- 검색시작  -->
                        <div class="input-group input-group-sm" id="searchInput" style="width: 150px;">
                    ...
                    <div class="nav nav-tabs custom-tabs">
					   <a class="nav-link active" href="/memberSign/collect">반려함</a>
					   <a class="nav-link" href="/memberSign/end">종결함</a>
					 </div>
 			...
 			success:function(result){
 				...
 				$.each(result.content,function(idx, signVO){
	 				str += `<tr data-original-emp-no="\${signVO.originalEmpNo}" data-reapp-emp-id="\${signVO.reappEmpId}">
						 		...
						 		<td class="text-center"><a href="/memberSign/retractDetail?appGroupCode=\${signVO.appGroupCode}">\${signVO.docTitle}</a></td>
