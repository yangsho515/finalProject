...
<%-- 	<p><sec:authentication property="principal.member"/></p> --%>
    ...
    <div class="header">
       <div class="leftHeader">
           <a href="/adminmain"><div class="logo">W7VKY</div></a>
           <nav>
            <a href="#" id="adminModeBtn"  onclick="changeColor(event, 'adminModeBtn')">관리자</a> 
               <a href="#" id="adminModeBtn">|</a> 
               <a href="#" id="employeeModeBtn" onclick="changeColor(event, 'employeeModeBtn')">직원</a>
            </nav>
        </div>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <div class="sideMenu">
            ...
            <a href="#" class="submenu-toggle"> 
                <span class="menu-icon"  onclick="location.href='/work/workDash'"><i class="bi bi-person-workspace"></i></span>
            ...
            <div class="sub-menu">
                ...
                <a href="/work/projWorkspace">업무리스트</a>
                <a href="/file/storage">파일함</a>
                <a href="/todo/list">업무메모함</a>
            </div>
        </div>
       <div class="sideMenu">
        <a href="#" class="submenu-toggle"> 
            ...
            <span class="menu-text" onclick="location.href='/contract/list'">계약 관리</span>
        </a>
       
        <div class="sub-menu">
            <a href="/contract/create">계약서 작성</a>
            <a href="/taxin/list">계산서 관리</a>
        </div>
       </div>
       <div class="sideMenu">
        <a href="#" class="submenu-toggle"> 
            <span class="menu-icon" onclick="location.href='/cash/cashList'"><i class="bi bi-graph-down"></i></span>
        ...
        <div class="sideMenu">
            ...
            <div class="sideMenu">
                ...
                <div class="sub-menu">
                    <a href="/board/list?bodType=1">일반 게시판</a>
            ...
            <div class="sideMenu">
                ...
                <a href="#" class="submenu-toggle"> 
                    <span class="menu-icon" onclick="location.href='/att/attManager'"><i
                        ...
                        <span class="menu-text" onclick="location.href='/att/attManager'">근태</span>
                    </a>
                    <div class="sub-menu">
                        <a href="/att/attManager">근태관리</a>
        ...
        <div id="adminMenu">
            <div class="sideMenu">  
            <a href="/personnel/list" class="submenu-toggle"> 
            ...
            <div class="sideMenu">
                ...
                <a href="/employeeSalary/salaryList" class="submenu-toggle"> 
                    <span class="menu-icon"><i class="bi bi-database"></i> </span>
                        <span class="menu-text">급여관리</span>
                    </a>
                </div>
                <div class="sideMenu">

                    <a href="#" class="submenu-toggle"> 
                        <span class="menu-icon"><i class="bi bi-clock" ></i></span>
                        <span class="menu-text">근태관리</span>
                    </a>
                    <div class="sub-menu">
                        <a href="/manageratt/managerAnnualList">연차 및 휴가 관리</a>
<!--                         <a href="/manageratt/managerWorkReport">근무 리포트</a> -->
                    </div>
                </div>
                <div class="sideMenu">
                    ...
                    <a href="#" class="submenu-toggle"> 
                        <span class="menu-icon"><i
                            class="bi bi-clipboard-check" onclick="location.href='/sign/signHome'"></i></span>
                            <span class="menu-text">전자결재관리</span>
                        </a>
                        <div class="sub-menu">
                            <a href="/sign/create">기안서 작성</a>
                            <a href="/sign/signList">결재 대기/요청함</a>
                            <a href="/sign/end">결재 종결/반려함</a>
                            <a href="/sign/reading">결재 참조함</a>
                            <a href="/sign/department">부서문서함</a>
                        </div>
                    </div>
                <div class="sideMenu">

                    <a href="/cash/budgetList" class="submenu-toggle"> 
                        <span class="menu-icon"><i class="bi bi-credit-card"></i></span>
                            <span class="menu-text">지출관리</span>
                        </a>
                    </div>
                <div class="sideMenu">
                    ...
                    <a href="#" class="submenu-toggle"> 
                        ...
                        <div class="sub-menu">
                            <a href="/system/notice"">공지사항 관리</a>
                            <a href="/system/qna">문의 관리</a>
                        </div>
                    </div>
                <div class="sideMenu ">

                    <a href="/system/report" class="submenu-toggle"> 
             ...
             <!--    <div class="sideMenu ">
                    ...
                    <a href="#" class="submenu-toggle"> 
                        <span class="menu-icon"><i class="bi bi-diagram-3"></i></span>
                            <span class="menu-text jojic">조직도</span>
                        </a>
                    </div> -->
        </div>
    </div>
