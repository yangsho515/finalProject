...
<!-- 헤더 include  -->
	...
	<div class="" tyle="font-size: 14px;">
		 <div class="hdFlex">
			...
			<h5 class=" contlist"> &nbsp;> 직원목록</h5>
		</div>
      <div style="display: flex; align-items: start; gap: 60px; margin-left: 0px;">
	 	<%-- 써머리 --%>
	 	<div class="bg-white rounded shadow-sm p-4" style="font-size: 15px; margin: 20px; padding: 0px; width: 35%; border:1px solid black; ">
           ...
           <!-- 차트 끝 -->   
              ...
              <div class="nav nav-tabs custom-tabs">
					   <a class="nav-link active" href="/personnel/list">직원</a>
					   <a class="nav-link" href="/personnel/resignList">퇴사자</a>
				   <!-- 검색시작  -->
                    <div class="input-group input-group-sm" id="searchInput" style="width: 300px; display: flex; border: 1px solid #ccc; border-radius: 2px; margin:5px;">
					    <input type="text" name="keyword" value="" class="form-control" placeholder="검색어 입력" style="border: none; flex: 1; "/>
					    <button type="button" id="btnSeach" class="btn btn-default" style="border: none; background-color: transparent; ">
					        <i class="fas fa-search"></i>
					    </button>
					</div>
                    <!-- 검색 끝  -->
				 	<div class="col-6 ms-auto" style="justify-content:right;display:flex; margin:8px;">
