...
<!-- ///// sidebar 끝 ///// -->
	<div>
                    ...
                    <div class="nav nav-tabs custom-tabs">
					   <a class="nav-link" href="/sign/signList">결재대기</a>
					   <a class="nav-link active" href="/sign/request">결재요청</a>
					 </div>
                   ...
                   <div class="" id="divPagingArea" style="width: 30%; margin: 0 auto; background-color:white;">
					    ...
					    <center>
					        ${articlePage.pagingArea}  <!-- 여기에 값이 출력되는지 확인 -->
					    </center>
					</div>
 	...
 	function selectSign(currentPage, keyword){
 		...
 		$.ajax({
 			...
 			success:function(articlePage){
 				...
 				$.each(articlePage.content,function(idx, signVO){
