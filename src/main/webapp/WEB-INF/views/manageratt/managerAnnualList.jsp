...
<div class="commuteList rounded h-100 p-4">
		...
		<div class="col-sm-6 col-xl-3">
			<div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
				...
				<div class="ms-3">
					...
					<span id="getEmpAnnual">0/15</span>
				</div>
			</div>
		</div>
	</div>
				<label>부서별 평균 출퇴근 시간</label>
				<div class="graph" style="width:600px;height:300px;">
	...
	<div class="row">
			...
			<table class="table" id="tbb">
				<thead class="thc">
					<tr class="tbc">
						...
						<th scope="col" class="col-center" style="display:none;">휴가 번호</th>
						...
						<th scope="col" class="col-center"> <button type="button" id="CheckAll">일괄 선택</button></th>
					</tr>
				</thead>
				<tbody id="tby">
				</tbody>
		...
		<div class="applycls">
			<button type="button" id="approve" class="greenBt conbtn">승인</button>
			<button type="button" id="reject" class="bluBt conbtn">반려</button>
		</div>
	</div>
...
function nvl(expr1, expr2) {
	...
	$.ajax({
		url: "/manageratt/managerAnnualList",
			...
			$.each(articlePage.content, function (idx, AnnualVOList){
				...
				str +=`
					<tr>
						...
						<td class="col-center" style="display:none;">\${AnnualVOList.annNo}</td>
						...
						<td class="col-center"><input class="checkbox" type="checkbox"
						data-emp-no="\${AnnualVOList.empNo}" data-ann-no="\${AnnualVOList.annNo}"/></td>
					</tr>`;
			});
	...
	function handleStatusChange(appStatus){
		...
		// alert("안녕")
		 $(".checkbox:checked").each(function(){
			 ...
			 let annNo = $(this).data("ann-no");
			 // empNo와 annNo를 객체로 만들어 배열에 추가
			 checked.push({empNo : empNo, annNo : annNo});
		 });
