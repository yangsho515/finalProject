      ...
      <h6 class="mb-4">기안 자세히 보기</h6>
		<form id="frm" action="/sign/createFormPost" method="post">
			...
			<div class="input-group mb-3">
                 ...
                 value="${appLineList2.empName}${appLineList2.postName}" style="background-color : #fff" disabled>
                 </c:forEach>
             </div>
				<div class="input-group mb-3">
            ...
            <div class="form-floating">
                <textarea  class="form-control" placeholder="Leave a comment here" id="docContent" style="height: 300px; background-color : #fff;"
            ...
            <div>
            	<label for="fileGroupNo" >첨부파일</label>
 				<!-- 첨부된 파일 목록 표시 -->
 				<div class="p-2 mb-2 bg-body text-dark" style="border: 1px solid #000;background-color : #fff; border-radius: 5px;">
